...
public abstract class AbstractContextTestCase
{
    ...
    throws AssertionError
  {
    ...
    try
    {
      ...
      final NamingEnumeration enumeration = m_context.list( "" );
    ...
    throws AssertionError
  {
    ...
    try
    {
      ...
      final Enumeration enumeration = m_context.list( "x/" );
    ...
    throws AssertionError
  {
    ...
    try
    {
      ...
      final Enumeration enumeration = m_context.list( "x/y" );
    ...
    throws AssertionError
  {
    try
    {
      ...
      NamingEnumeration enumeration = m_context.listBindings( "" );
      assertTrue( enumeration.hasMore() );
      try
      {
        Object result = enumeration.next();
  ...
  protected abstract Context getRoot()
    throws Exception;
